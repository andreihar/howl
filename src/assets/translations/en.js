export const en = {
	translation: {
		...
		footer: {
			about: "About us",
			description: "HOWL Gaming is a professional e-sports organization, the goal of which is the development and support of electronic sports not only on the territory of the CIS, but also throughout the world.",
			contacts: "Contacts",
			copyright: "All rights reserved"
		},
		home: {
			open: "opened",
			text: "Website of our favorite team officially opens!"
		},
		news: {
			reports: "Reports",
			report: "Report",
		...
		teams: {
			...
			<div class="desc">
			<p>On August 7, 2017, when the <2></2><strong>RHB</strong> clan left the organization and created their own independent team, for which the same players continued to play.</p>
